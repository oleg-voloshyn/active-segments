...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { description: @race.description, end_date: @race.end_date, name: @race.name, start_date: @race.start_date } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { description: @race.description, end_date: @race.end_date, name: @race.name, start_date: @race.start_date } }
